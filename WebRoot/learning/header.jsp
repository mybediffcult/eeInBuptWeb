...
<div class="total_header">
		...
		<div class="big_text">
		   <div class="logo_text"><h2>学籍系统</h2></div>
		</div>
		</c:if>
		<c:if test="${users.upower==1}">
		<div class="big_text">
		   <div class="logo_text"><h2>学员中心</h2></div>
		</div>
		</c:if>
		<c:if test="${users.upower==10}">
		<div class="big_text">
		   <div class="logo_text"><h2>教师中心</h2></div>
		</div>
		</c:if>
